...
$mainDirectory = "Automation"  # Change this to the directory that contains the folder that contains the prerequisites folder
$subDirectory = "prereqs" # Change this to the directory that contains the IIS prerequisites
